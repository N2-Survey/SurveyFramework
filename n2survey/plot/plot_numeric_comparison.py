...
>>>>>>> 1d08c7b (First implementation of comparison plots for numeric questions. New file `plot_numeric_comparison.py`. Currently displayed median is not correct, but a placeholder.)
